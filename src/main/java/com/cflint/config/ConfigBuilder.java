...
public class ConfigBuilder {
    ...
    /**
     * Add a custom configuration on top of the baseline.
     *  Hint: most configurations do not need this.
     * @param fileName
     */
    ...
    public CFLintChainedConfig build(){
        ...
        return new CFLintChainedConfig(defaultConfig).createNestedConfig(configFileConfig).createNestedConfig(cmdLineConfig);
    }
